...
type Node struct {
	...
	// commit blocks from Huron to the application, and relay submitted
	// transactions from the applications to Huron.
...
// huron periodically initiates gossip or monologue as triggered by the
// controlTimer.
func (n *Node) huron(gossip bool) {
